...
<style>
   * {
   ...
   body {
       background: #05705d;
       background: linear-gradient(rgba(0,0,0,0.9),rgba(0,0,0,0.8)), url("https://raw.githubusercontent.com/SuhailTechInfo/Suhail-Md/main/lib/assets/pk.jpg");
...
<body translate="no">
    <ul>
        ...
        <li><a href='https://youtube.com/SuhailTechInfo' > YOUTUBE </a></li>
    ...
    <h1 style="color: #d4cfcf; "> SUHAIL MD ❤️</h1>
<br>
    <h1>
        A Simple <span style="border-bottom:4px dotted #3c3c3c; color: #d4cfcf;">Pakistani</span> Whatsapp Bot.
